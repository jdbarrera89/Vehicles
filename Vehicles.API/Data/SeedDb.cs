...
namespace Vehicles.API.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Luis", "Salazar", "luis@yopmail.com", "300 681 5174", "Calle Medellin", UserType.Admin);
            await CheckUserAsync("2020", "David", "Barrera", "dbarrera@yopmail.com", "300 681 5174", "Calle Medellin", UserType.User);
            await CheckUserAsync("3030", "Yiset", "Lobo", "yiseth@yopmail.com", "300 681 5174", "Calle Medellin", UserType.User);
        }
